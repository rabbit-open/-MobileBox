...
public class FrescoUtils {
            ...
            protected void onNewResultImpl(DataSource<Void> dataSource) {
                ...
                if (mListener != null) {
                    ...
                    if (bp != null && bp.exists()) {
                        mListener.onLoadingSuccess(null);
                    } else {
    ...
    public static void preLocalImageMemCache2(final String uri, final ImagePreloadListener
            mListener) {
        if (TextUtils.isEmpty(uri)) {
            return;
        }
        ...
        dataSource.subscribe(new BaseDataSubscriber<CloseableReference<CloseableImage>>() {
            ...
            protected void onNewResultImpl(DataSource<CloseableReference<CloseableImage>> source) {
                ...
                if (image instanceof CloseableBitmap) {
                    ...
                    if (mListener != null) {
                        if (picbitmap != null) {
                            mListener.onLoadingSuccess(picbitmap);
                        } else {
                            mListener.onLoadingFailed();
                        }
                    }
