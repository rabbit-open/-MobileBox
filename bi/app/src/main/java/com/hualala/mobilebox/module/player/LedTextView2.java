...
public class LedTextView2 extends android.support.v7.widget.AppCompatTextView {
    ...
    public LedTextView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public LedTextView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LedTextView2(Context context) {
        this(context, null, 0);
    }
