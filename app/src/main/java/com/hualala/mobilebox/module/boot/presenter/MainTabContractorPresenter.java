...
public class MainTabContractorPresenter extends BasePresenter<MainTabView> implements IMainView.IMainViewListener {

    private MainViewModel viewModel;

    public MainTabContractorPresenter(LifecycleOwner lifecycleOwner, MainTabView mView) {
        super(mView);
    ...
    public MainTabContractorPresenter(LifecycleOwner lifecycleOwner) {
