...
public class SystemUtils {
    ...
    public static String getLocalMacAddress() {
        try {
            WifiManager wifi = (WifiManager) MBContext.getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
    ...
    public static String getAppVersionName() {
        PackageManager packageManager = MBContext.getContext().getPackageManager();
        PackageInfo packInfo = null;
        try {
            packInfo = packageManager.getPackageInfo(MBContext.getContext().getPackageName(), 0);
    ...
    public static String getMetaData(String key) {
        ...
        try {
            ApplicationInfo ai = MBContext.getContext().getPackageManager().getApplicationInfo(MBContext.getContext().getPackageName(),
    ...
    public static boolean isWifiNetwork() {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) MBContext.getContext().getSystemService(
