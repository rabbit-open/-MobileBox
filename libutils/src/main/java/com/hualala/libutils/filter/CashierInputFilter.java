package com.hualala.libutils.filter;
...
public class CashierInputFilter implements InputFilter {
    ...
    public CashierInputFilter(Pattern pattern) {
        this(2, Float.MAX_VALUE, null);
    }

    public CashierInputFilter(int pointLenght) {
        this(pointLenght, Float.MAX_VALUE, null);
    }

    public CashierInputFilter(int pointLenght, float maxvaule, Pattern pattern) {
        this.pointLenght = pointLenght;
        this.maxValue = maxvaule;
        mPattern = pattern == null ? Pattern.compile("([0-9]|\\.)*") : pattern;
    }
