...
public class MainVMPresenter extends BasePresenter<MVPVMActivity> implements IExampleContractor.IExamplePresenter {

    //自动解耦NET
    private ExampleViewModel viewModel = new ExampleViewModel();//不需关心Rxjava 结果

    public MainVMPresenter(LifecycleOwner lifecycleOwner) {
